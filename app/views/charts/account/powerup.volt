<script>
  d3.json("/api/account/{{ account.name }}/energize").get(function(error, rows) {
    var data = rows;
    ...
    var xLabelTitle = new Plottable.Components.TitleLabel("90-day Energizations", "0");
    ...
    table.renderTo("svg#account-energize");
  });
</script>
