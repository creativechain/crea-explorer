  ...
  {% for comment in comments %}
    <div class="row">
      <div class="one wide mobile hidden column">
        <div class="ui small center aligned header" style="color: #f3f3f3f3">
          ...
          {{ comment.net_votes }}
          <div class="sub header" style="color: #f3f3f3f3">#{{ loop.index }}</div>
        </div>
      </div>
      <div class="twelve wide column">
        <div class="ui large header">
          <a href="{{ comment.url }}" style="color: #f3f3f3f3">
            {{ comment.title }}
          </a>
          <div class="sub header">
            ...
            <span class="ui small left floated green header mobile visible">
              ...
              <span class="sub header" style="color: #f3f3f3f3">
                Pending:<br/>{{ comment.pending_payout_value }} VIT
              </span>
            </span>

            <span style="color: #f3f3f3f3">
      ...
      <div class="three wide center mobile hidden aligned column">
        <div class="ui green header">
          {{ comment.total_payout_value }} VIT
          <div class="sub header" style="color: #f3f3f3f3">
             Pending:<br/>{{ comment.pending_payout_value }} VIT
          </div>
        </div>
      </div>
