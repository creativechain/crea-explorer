  ...
  <div class="ui vertically divided equal height grid">
    ...
    <div class="row">
      <div class="three wide center aligned column">
        <div class="mobile hidden">
          <img src="https://img.creaconnect.com/@{{ post.author }}?size=80" class="ui tiny centered spaced circular bordered image">
        ...
        <div class="mobile visible">
          <img src="https://img.creaconnect.com/@{{ post.author }}?size=60" class="ui right floated spaced circular bordered image">
        </div>
      </div>
      <div class="thirteen wide column">
          ...
          <div class="comment">
            <div class="content">
              ...
              <div class="ui horizontal tall stacked segments">
                ...
                <div class="ui center aligned segment">
                  <div class="ui sub header">recreas</div>
                  {{ recreas }}
              ...
              <div class="metadata">
                <div class="date">
                  ...
                  {% if post.origin() %}
                    ( via
                    {% if post.origin() == 'creary' %}
                    <a href="https://creary.net/">creary.net</a>
    ...
    <div class="row stackable">
      ...
      <div class="ten wide column">
        ...
        <div class='creaconnect reply'>
          <form class='ui reply form' action='http://creajs.com/sign/comment' method='get' target='iframe'>
            <input type='hidden' name='parent_permlink' value='{{ posts[0].permlink}}'>
            <input type='hidden' name='parent_author' value='{{ posts[0].author}}'>
            <input type="hidden" name='json_metadata' value='{"app": "crearydb/0.1", "format": "markdown"}'>
    ...
    <div class="ui notice modal">
      ...
      <div class="content">
        <div class="ui padded basic segment" style="font: 16px">
          ...
          <p>
            Once you create a post or reply, it may take up to 1 minute to appear here on CrearyDB.
          </p>
        </div>
        <div class="actions">
    ...
    <div class="ui modal creaconnect">
      <div class="content">
...
$( document ).ready(function() {
  var validation  = {
      ...
      settings = {
        ...
        onSuccess: function(e){
          var form = $(this),
              data = form.serialize()
              embed = $(".ui.modal.creaconnect .ui.embed")
                .attr("data-url", "https://creajs.com/sign/comment?" + data);
          $('.notice.modal')
            .modal('show')
          ;
          $(".ui.modal.creaconnect")
            .modal({
              allowMultiple: false,
              onShow: function() {
                $(".ui.modal.creaconnect .ui.embed").embed();
              },
            })
  ...
  $("a.reply[data-permlink][data-author]").on('click', function() {
    var permlink = $(this).attr("data-permlink"),
        ...
        json_metadata = $("<input type='hidden' name='json_metadata' value='{\"app\": \"crearydb/0.1\", \"format\": \"markdown\"}'>"),
        ...
        form = $("<form class='ui reply form' action='http://creajs.com/sign/comment' method='get' target='iframe'>").append(parent_author, parent_permlink, json_metadata, body, button),
        container = $("<div class='creaconnect reply' data-author='"+author+"' data-permlink='"+permlink+"'>").append(form),
        display = $(this).data("display");
    $("div.creaconnect[data-author="+author+"][data-permlink="+permlink+"]").remove();
    if(!display) {
      form.form(settings);
