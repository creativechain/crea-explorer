      ...
      '.volt' => function ($view) {
        ...
        $compiler->addFunction(
          ...
          function ($resolvedArgs, $exprArgs) {
            return 'CrearyDB\Helpers\Markdown::string(' . $resolvedArgs . ')';
          }
        );
        return $volt;
      }
...
$di->set('dispatcher', function () {
  ...
  $dispatcher->setDefaultNamespace('CrearyDB\Controllers');
...
$di->set('convert', function () { return new CrearyDB\Helpers\Convert(); });
$di->set('largeNumber', function () { return new CrearyDB\Helpers\LargeNumber(); });
$di->set('reputation', function () { return new CrearyDB\Helpers\Reputation(); });
$di->set('timeAgo', function () { return new CrearyDB\Helpers\TimeAgo(); });
$di->set('opName', function () { return new CrearyDB\Helpers\OpName(); });
